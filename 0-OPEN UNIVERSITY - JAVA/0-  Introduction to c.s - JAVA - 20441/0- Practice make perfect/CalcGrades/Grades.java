...
public class Grades {
    public static void main(String args[]) {
        ...
        if (numberOfAssignments <= 4) {
        ...
        } else if (numberOfAssignments >= 7) { // the number of assignments the student submitted is >=7
                                               // …see next slide;
            ...
            switch (numberOfAssignments) {
                ...
                case 7:
                case 8:
                    if (homeworkAverage > examGrade)// the homework average grade must “protect" the student
                    {
                        if (examGrade >= PASS) {
