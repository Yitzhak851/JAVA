...
//     // Recursive function to update the subtree information
//     private int[] updateNodeInfo(TreeNode<T> node) {
//         if (node == null) {
//             return new int[]{0, 0};  // size, depth_sum
//         }
...
//     // Function to calculate the average depth of nodes in the subtree rooted at the given node
//     public double averageDepthOfNodesInSubtree(TreeNode<T> node) {
//         if (node == null || node.subtreeSize == 0) {
//             return 0;
//         }
